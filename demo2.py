...
txt5.insert(0, "row 2" + " " + "column 0")

txt6 = Entry(win, bd=2, justify="center")
txt6.grid(row=2, column=1)
txt6.insert(0, "row 2" + " " + "column 1")

txt7 = Entry(win, bd=2, justify="center")
txt7.grid(row=3, column=0)
txt7.insert(0, "row 3" + " " + "column 0")
